  ...
  return (
    <Container id="education">
      <div className="education-text">
        ...
        <ScrollAnimation animateIn="fadeInDown" delay={0.3 * 1000} style={{ marginTop: "2rem", marginBottom: "2rem" }}>
        ...
        <ScrollAnimation animateIn="fadeInDown" delay={0.4 * 1000} style={{ marginTop: "2rem", marginBottom: "2rem" }}>
